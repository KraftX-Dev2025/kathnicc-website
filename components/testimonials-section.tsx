    ...
    >
      ...
      >
        ...
        <div className="bg-[#786755] py-16 px-6 relative overflow-visible">
          ...
          >
            {testimonials.map((testimonial, index) => (
              <motion.div
                key={index}
                variants={itemVariants}
                className="bg-[#f9f6ef] p-8 py-32 shadow-lg min-h-[400px] flex flex-col justify-center"
              >
          ...
          >
            {/* Left Column - Text */}
            <motion.div variants={itemVariants} className="relative z-20 left-64">
              ...
              <p className="text-[#f9f6ef] text-base md:text-xl leading-relaxed pr-64">
